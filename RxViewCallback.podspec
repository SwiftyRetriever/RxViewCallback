...
Pod::Spec.new do |s|
  ...
  s.author             = { "zevwings" => "email@address.com" }
  # Or just: s.author    = "zevwings"
  # s.authors            = { "zevwings" => "email@address.com" }
  ...
  s.source       = { :git => "https://github.com/zevwings/RxViewCallback.git", :commit => "3369c395116bcce281a95ec5b3703b0bdd05b30c" }
